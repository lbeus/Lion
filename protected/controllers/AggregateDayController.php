...
class AggregateDayController extends ERestController
{
	/**
	...
	{
		$model=new AggregateDay;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['AggregateDay']))
		{
			$model->attributes=$_POST['AggregateDay'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('AggregateDay');
	...
	{
		$model=new AggregateDay('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['AggregateDay']))
			$model->attributes=$_GET['AggregateDay'];
	...
	{
		$model=AggregateDay::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='aggregate-day-form')
		{
