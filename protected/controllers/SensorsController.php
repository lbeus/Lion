...
class SensorsController extends ERestController
{
	/**
	...
	{
		$dataProvider=new CActiveDataProvider('Sensors', array(
    		'criteria'=>array(
    			'with'=>array('fSensorTypes'),
    		),
    	));
	...
	{
		$model=Sensors::model()->with('fSensorTypes')->findByPk($id);
		if($model===null)
