...
class AggregateMonthController extends ERestController
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['AggregateMonth']))
		{
			$model->attributes=$_POST['AggregateMonth'];
			if($model->save())
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='aggregate-month-form')
		{
