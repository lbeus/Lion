<?php if (!empty($requests)): ?> <h5> SMS requests </h5>
				...
				<?php foreach ($requests as $request): ?>
					<tr>
						...
						<td class="align-center buttons buttons-small">							
                           <?php echo $request->isactive ? 'Approved' : anchor('admin_notifications/approvedSms/' . $request->notificationid .'/'.$request->xmlname, 'Approve', 'Approved'); ?>
                                    <?php    echo anchor('admin_notifications/DisapproveSMS/' . $request->notificationid, 'Disapprove' ); ?>                                        
...
<?php else: ?>
	<div class="blank-slate">
		...
		<h2>There are no SMS requests  </h2>
	</div>
<?php endif; ?>
