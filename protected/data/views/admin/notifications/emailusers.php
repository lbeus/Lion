<?php if (!empty($requests)): ?> <h5> Email users </h5>
				...
				<?php foreach ($requests as $member): ?>
					<tr>                                                    
                                                ...
                                                <td class="align-center buttons buttons-small">							                                                
                                                 <?php  echo anchor('admin_notifications/DisapproveEmail1/' . $member->notificationid .'/'.$member->xmlname, 'Disapprove' ); ?>        
						</td>						
						</tr>
				<?php endforeach; ?>
			</tbody>
...
<?php else: ?>
	<div class="blank-slate">
		...
		<h2>There are no Email users </h2>
	</div>
<?php endif; ?>
