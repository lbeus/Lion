	...
	<div id="mainmenu">
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				...
				array('label'=>'Users', 'url'=>array('/prodUsers/index'), 'visible'=>!Yii::app()->user->isGuest),
				array('label'=>'GSN', 'url'=>array('/diGsn/index'), 'visible'=>!Yii::app()->user->isGuest),				
				array('label'=>'Sensors', 'url'=>array('/diSensors/index'), 'visible'=>!Yii::app()->user->isGuest),	
