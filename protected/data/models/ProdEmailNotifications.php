...
class ProdEmailNotifications extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('notification_id, time_notification_asked, time_notification_approved, is_active, unit_id, sensor_id, prod_user_id, unit_name, unit_name_upper, sensor_name, xml_name, critical_value, resending_interval', 'safe', 'on'=>'search'),
		);
	}
