...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'criteria_type'); ?>
		<?php echo $form->textField($model,'criteria_type'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'criteria_type_name'); ?>
		<?php echo $form->textField($model,'criteria_type_name'); ?>
	</div>
