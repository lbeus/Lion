...
<?php $form=$this->beginWidget('CActiveForm', array(
	'id'=>'prod-email-notifications-form',
	...
	<div class="row">
		<?php echo $form->labelEx($model,'critical_type'); ?>
		<?php echo $form->textField($model,'critical_type'); ?>
		<?php echo $form->error($model,'critical_type'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'critical_type_name'); ?>
		<?php echo $form->textField($model,'critical_type_name'); ?>
		<?php echo $form->error($model,'critical_type_name'); ?>
	</div>
