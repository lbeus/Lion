    ...
    <body>
        ...
        <div class="container" id="page">
            ...
            <div id="sidemenu">
                ...
                $this->widget('zii.widgets.CMenu', array(
                    'items' => array(
                        array('label' => 'New', 'url' => array('/reportSubscription/userReportsMain')),
                        array('label' => 'Daily reports', 'url' => array('/reportSubscription/userReportsDaily')),
                        array('label' => 'Monthly reports', 'url' => array('/reportSubscription/userReportsMonthly')),
                        array('label' => 'New subscription', 'url' => array('/reportSubscription/userReportsNewSubscription')),
                        array('label' => 'All subscriptions', 'url' => array('/reportSubscription/userReportsSubscription')),
                    ),
                ));
                ?>
            </div><!-- sidemenu -->
