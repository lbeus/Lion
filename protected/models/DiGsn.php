	...
	public function rules()
	{
		...
		return array(
			...
			array('last_change, date_activated_id, date_deactivated_id, database_password', 'safe'),
                        array('database_password, username, password, database_schema, database_user, sftp_username,sftp_password, gsn_name, gsn_url, gsn_port, port_ssl, database_port','required, notification_folder,notification_backup_folder'),
