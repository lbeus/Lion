...
/**
 * This is the model class for table "f_readings".
 *
 * The followings are the available columns in table 'f_readings':
 ...
 * @property DiTime $time
 * @property DiUnits $unit
 */
class FReadings extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return FReadings the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			...
			'time' => array(self::BELONGS_TO, 'DiTime', 'time_id'),
