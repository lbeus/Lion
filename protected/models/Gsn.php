 ...
 */
class Gsn extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Gsn the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('city, state, username, password, database_schema, database_user, database_password', 'length', 'max'=>30),
			array('is_active, is_dummy', 'length', 'max'=>1),
			array('gsn_ip', 'length', 'max'=>16),
			array('last_change, date_activated_id, date_deactivated_id', 'safe'),
	...
	public function relations()
	{
		...
		return array(
			'fReadings' => array(self::HAS_MANY, 'FReadings', 'gsn_id'),
			...
			'diSensors' => array(self::MANY_MANY, 'DiSensors', 'etl_log(gsn_id, sensor_id)'),
			'diSensors1' => array(self::HAS_MANY, 'DiSensors', 'gsn_id'),
