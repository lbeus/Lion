...
/**
 * This is the model class for table "agg_day_part".
 *
 * The followings are the available columns in table 'agg_day_part':
 ...
 */
class AggregateDayPart extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return AggregateDayPart the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('gsn_id, sensor_id, unit_id, date_id, day_part_id', 'numerical', 'integerOnly'=>true),
			array('avg_value, max_value, min_value, amplitude', 'numerical'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('reading_id, gsn_id, sensor_id, unit_id, date_id, day_part_id, avg_value, max_value, min_value, amplitude', 'safe', 'on'=>'search'),
		);
	}
