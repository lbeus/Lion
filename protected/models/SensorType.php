 ...
 */
class SensorType extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return SensorType the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			'sensors' => array(self::BELONGS_TO, 'Sensors', 'sensor_id'),
	...
	{
	    return array('unit_id','sensor_id');
